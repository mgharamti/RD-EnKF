function [current, xticks, xtickslabel, goodtime, observation, openloop, forecast, analysis, exp] = ...
...
for i = 1:gauges.want.num
    ...
    for e = 1:num_exps
        ...
        if plot_ol
            tmp.ens_mean_ol = ol.ensemble(2,         find_obs); 
            tmp.ens_sd_ol   = ol.ensemble(4,         find_obs); 
            tmp.ensemble_ol = ol.ensemble(6:2:end-1, find_obs);
        end  
    ...
    if num_exps > 1
        ...
        for e = 1:num_exps
            ...
            if num_exps == 2
                ...
                if plot_ol
                    L = legend([ob_a, ob_r, op, mf , ma], 'Used Obs'          , ...
                            ...
                            L = legend([ob_a, ob_r, mf , ma], 'Used Obs'          , ...
                                sprintf('Rejected Obs: %.2f%%'       , 100-observation{4, o, e}/observation{3, o, e}*100), ...
                                sprintf('Prior Mean, RMSE: %.2f'     , nanmean(forecast{2, o, e})), ...
                                sprintf('Posterior Mean, RMSE: %.2f' , nanmean(analysis{2, o, e})), ...
                                'Location', 'NorthEast');
                ...
                if sum(inf_flav_n) > 1
                    ...
                    plot(current, forecast{9, o, e}, '-', 'Color', bK, 'LineWidth', 2); hold on
                    ...
                    L = legend(sprintf('Prior Inflation Mean, avg: %.2f'      , nanmean(forecast{9,  o, e})), ...
                            'Location', 'NorthEast');
